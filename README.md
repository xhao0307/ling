...
- `DASHSCOPE_API_KEY` (enable LLM integration when set)
...
- `CITYLING_IMAGE_API_KEY` (optional, fallback to `DASHSCOPE_API_KEY`)
...
- `CITYLING_TTS_API_KEY` (optional, fallback to `DASHSCOPE_API_KEY`)
