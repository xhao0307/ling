...
DASHSCOPE_API_KEY="${CITYLING_DASHSCOPE_API_KEY:-${DASHSCOPE_API_KEY:-${CITYLING_IMAGE_API_KEY:-${CITYLING_LLM_API_KEY:-}}}}"
...
if [[ -f "$ROOT_DIR/.env" ]]; then
  ...
  DASHSCOPE_API_KEY="${CITYLING_DASHSCOPE_API_KEY:-${DASHSCOPE_API_KEY:-${CITYLING_IMAGE_API_KEY:-${CITYLING_LLM_API_KEY:-$DASHSCOPE_API_KEY}}}}"
...
if [[ -z "$DASHSCOPE_API_KEY" ]]; then
  echo "缺少 DashScope Key，请设置 CITYLING_DASHSCOPE_API_KEY / DASHSCOPE_API_KEY / CITYLING_IMAGE_API_KEY / CITYLING_LLM_API_KEY"
  exit 1
fi
